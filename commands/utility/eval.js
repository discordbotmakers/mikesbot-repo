...
module.exports ={
    name: "eval",
    aliases: ['testjscode', 'code', 'evall', 'eeval'],
    description: "evaluate code from javascript!",
    usage: "[p]eval <code>",
    run: async(bot, message,args) => {
        if(!message.author.id === owners) return message.channel.send(`For security reasons. Only the bot owner can use this command`);
